...
public class RetailerCrop {
    ...
    @Size(max = 200)
    @Column(name = "retailer_location_address")
    private String retailerLocationAddress;
    ...
    public String getRetailerLocationAddress() {
        return retailerLocationAddress;
    }

    public void setRetailerLocationAddress(String retailerLocationAddress) {
        this.retailerLocationAddress = retailerLocationAddress;
    }
